...
{"insights":[{"item":"項目名","description":"何を測る指標か・役割を20〜30字程度の説明文で（例：血中の尿酸濃度を示す。高値は痛風リスクに繋がる）","value":"数値と前回比を「9 mm ※前回13 mmから減少(▲23.1%)」の形式で。増加は+x.x%、減少は▲x.x%、小数点第1位まで","insight":"時期・過去データを踏まえた示唆","recommendations":["対策1","対策2"]}]}
